...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgheight', type=int, default=224, help=("set the height of the image in pixels"))
    parser.add_argument('--imgwidth', type=int, default=224, help=("set the width of the image in pixels"))
